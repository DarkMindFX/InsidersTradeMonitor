...
namespace PPT.DAL.MSSQL 
{
    ...
    public class Form4ReportDal: SQLDal, IForm4ReportDal
    {
        ...
        protected SqlCommand AddUpsertParameters(SqlCommand cmd, Form4Report entity)
        {
                ...
                SqlParameter pOtherText = new SqlParameter("@OtherText", System.Data.SqlDbType.Bit, 0, ParameterDirection.Input, false, 0, 0, "OtherText", DataRowVersion.Current, (object)entity.OtherText != null ? (object)entity.OtherText : DBNull.Value);   cmd.Parameters.Add(pOtherText); 
        ...
        protected Form4Report Form4ReportFromRow(DataRow row)
        {
            var entity = new Form4Report();
                    ...
                    entity.OtherText = !DBNull.Value.Equals(row["OtherText"]) ? (System.Boolean)row["OtherText"] : default(System.Boolean);
