...
namespace ITM.DAL.MSSQL
{
    ...
    public class DerivativeTransactionDal : SQLDal, IDerivativeTransactionDal
    {
        ...
        protected ITM.Interfaces.Entities.DerivativeTransaction DerivativeTransactionFromRow(DataRow row)
        {
            return ITM.Utils.Convertors.DerivativeTransactionConvertor.DerivativeTransactionFromRow(row);
        }
