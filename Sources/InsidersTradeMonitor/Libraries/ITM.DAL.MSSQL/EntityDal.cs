...
namespace ITM.DAL.MSSQL 
{
    ...
    public class EntityDal: SQLDal, IEntityDal
    {
        ...
        protected SqlCommand AddUpsertParameters(SqlCommand cmd, Entity entity)
        {
                ...
                SqlParameter pCIK = new SqlParameter("@CIK", System.Data.SqlDbType.NVarChar, 250, ParameterDirection.Input, false, 0, 0, "CIK", DataRowVersion.Current, (object)entity.CIK != null ? (object)entity.CIK : DBNull.Value);   cmd.Parameters.Add(pCIK); 
        ...
        protected Entity EntityFromRow(DataRow row)
        {
            var entity = new Entity();
                    ...
                    entity.CIK = !DBNull.Value.Equals(row["CIK"]) ? (System.String)row["CIK"] : default(System.String);
