...
namespace ITM.Functions.Common
{
    public class FunctionHelper
    {
        ...
        public void SetCreatedModifiedProperties(object obj, string propNameDate, string propNameID, ITM.Interfaces.Entities.User currentUser = null)
        {
        ...
        public ObjectResult CreateResult(HttpStatusCode code, object resultDto = null, string errorMessage = null)
        {
            ...
            {
                result = new ObjectResult(ToJosn(new ITM.DTO.Error()
                {
                    Code = (int)code,
