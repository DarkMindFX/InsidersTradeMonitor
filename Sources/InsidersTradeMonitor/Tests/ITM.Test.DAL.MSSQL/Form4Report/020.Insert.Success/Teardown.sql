...
DECLARE @IssuerID BIGINT = 100013
DECLARE @ReporterID BIGINT = 100007
DECLARE @IsOfficer BIT = 1
DECLARE @IsDirector BIT = 1
DECLARE @Is10PctHolder BIT = 1
DECLARE @IsOther BIT = 1
DECLARE @OtherText NVARCHAR(250) = 'OtherText 4bb880efd3784e27ab2a1ac6b006e038'
DECLARE @OfficerTitle NVARCHAR(50) = 'OfficerTitle 4bb880efd3784e27ab2a1ac6b006e038'
